...
#include <aspect/particle/interpolator/quadratic_least_squares_cell_average_partial.h>
...
namespace aspect
{
  namespace Particle
  {
    namespace Interpolator
    {
      ...
      QuadraticLeastSquaresCellAveragePartial<dim>::properties_at_points(const ParticleHandler<dim> &particle_handler,
      ...
      template <int dim>
      void
      QuadraticLeastSquaresCellAveragePartial<dim>::declare_parameters (ParameterHandler &prm)
      {
      ...
      template <int dim>
      void
      QuadraticLeastSquaresCellAveragePartial<dim>::parse_parameters (ParameterHandler &prm)
      {
        prm.enter_subsection("Postprocess");
        {
          prm.enter_subsection("Particles");
...
namespace aspect
{
  namespace Particle
  {
    namespace Interpolator
    {
      ASPECT_REGISTER_PARTICLE_INTERPOLATOR(QuadraticLeastSquaresCellAveragePartial,
                                            "quadratic least squares cell average partial",

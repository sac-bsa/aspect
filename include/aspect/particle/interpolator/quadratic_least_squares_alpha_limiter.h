...
#ifndef _aspect_particle_interpolator_quadratic_least_squares_alpha_limiter_h
#define _aspect_particle_interpolator_quadratic_least_squares_alpha_limiter_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Interpolator
    {
       ...
       */
      template <int dim>
      class QuadraticLeastSquaresAlphaLimiter : public Interface<dim>, public aspect::SimulatorAccess<dim>
      {
        public:
          /**

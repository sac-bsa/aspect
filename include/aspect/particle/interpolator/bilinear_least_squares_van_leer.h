...
#ifndef _aspect_particle_interpolator_bilinear_least_squares_van_leer_h
#define _aspect_particle_interpolator_bilinear_least_squares_van_leer_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Interpolator
    {
       ...
       */
      template <int dim>
      class BilinearLeastSquaresVanLeer : public Interface<dim>, public aspect::SimulatorAccess<dim>
      {
        public:
          /**

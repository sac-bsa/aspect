...
#ifndef _aspect_particle_interpolator_bilinear_svd_h
#define _aspect_particle_interpolator_bilinear_svd_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Interpolator
    {
       ...
       */
      template <int dim>
      class BilinearSVDLeastSquares : public Interface<dim>, public aspect::SimulatorAccess<dim>
      {
        public:
          /**

...
#ifndef _aspect_particle_interpolator_biquadratic_qr_h
#define _aspect_particle_interpolator_biquadratic_qr_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Interpolator
    {
       ...
       */
      template <int dim>
      class BiquadraticQRLeastSquares : public Interface<dim>, public aspect::SimulatorAccess<dim>
      {
        public:
          /**

...
#ifndef _aspect_particle_interpolator_quadratic_least_squares_cell_average_full_h
#define _aspect_particle_interpolator_quadratic_least_squares_cell_average_full_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Interpolator
    {
       ...
       */
      template <int dim>
      class QuadraticLeastSquaresCellAverageFullLimiter : public Interface<dim>, public aspect::SimulatorAccess<dim>
      {
        public:
          /**

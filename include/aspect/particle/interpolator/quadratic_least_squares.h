...
#ifndef _aspect_particle_interpolator_quadratic_qr_h
#define _aspect_particle_interpolator_quadratic_qr_h
...
namespace aspect
{
  namespace Particle
  {
    ...
    {
      /**
       * Return the interpolated properties of all particles of the given cell using quadratic least squares method.
       * 

...
#ifndef _aspect_particle_interpolator_peskin_weighting_h
#define _aspect_particle_interpolator_peskin_weighting_h
...
namespace aspect
{
  namespace Particle {
    namespace Interpolator {
       ...
       */
      template<int dim>
      class PeskinWeighting : public Interface<dim>, public aspect::SimulatorAccess<dim> {
      public:
        /**

...
#ifndef _aspect_particle_interpolator_quadratic_least_squares_cell_average_partial_h
#define _aspect_particle_interpolator_quadratic_least_squares_cell_average_partial_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Interpolator
    {
       ...
       */
      template <int dim>
      class QuadraticLeastSquaresCellAveragePartial : public Interface<dim>, public aspect::SimulatorAccess<dim>
      {
        public:
          /**

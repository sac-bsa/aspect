...
#ifndef _aspect_particle_interpolator_quadratic_least_squares_square_wave_round_h
#define _aspect_particle_interpolator_quadratic_least_squares_square_wave_round_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Interpolator
    {
       ...
       */
      template <int dim>
      class QuadraticLeastSquaresSquareWaveRound : public Interface<dim>, public aspect::SimulatorAccess<dim>
      {
        public:
          /**
        ...
        private:
          ...
          /**
           * For each interpolated particle property, there is the option to
           * use the square wave rounder.
           */
          std::vector<bool> use_square_wave;
      };
    }
  }
}
